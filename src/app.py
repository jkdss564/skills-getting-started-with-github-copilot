...
activities = {
    ties = {
        ...
        "Basketball Team": {
            "description": "Join our competitive basketball team for league games and tournaments",
        ...
        "Drama Club": {
            ...
            "max_participants": 25,
            "participants": ["julia@mergington.edu", "lucas@mergington.edu"]
        },
        "Art Studio": {
        ...
        "Debate Team": {
            "description": "Develop critical thinking and public speaking through organized debates",
